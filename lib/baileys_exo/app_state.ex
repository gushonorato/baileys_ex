defmodule BaileysExo.AppState do
  @moduledoc false

  alias BaileysExo.AppState.Decoder
  ...
  alias BaileysExo.Proto.{ExternalBlobReference, SyncdMutations, SyncdPatch, SyncdSnapshot}
  ...
  defp put_missing_patch_version(%SyncdPatch{version: nil} = patch, collection) do
    case Integer.parse(collection.attrs["version"] || "") do
      {version, ""} when version >= 0 ->
        %{patch | version: %BaileysExo.Proto.SyncdVersion{version: version + 1}}
