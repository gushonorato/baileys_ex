defmodule Baileys.HistorySync do
  @moduledoc """
  ...
  alias Baileys.Proto.HistorySync, as: ProtoHistorySync
  alias Baileys.Proto.Message, as: ProtoMessage
  alias Baileys.Proto.Message.HistorySyncNotification
  ...
  defp project_message(%WebMessageInfo{} = web_message, fallback_jid, mapping_index) do
    proto_key = web_message.key || %Baileys.Proto.MessageKey{}
