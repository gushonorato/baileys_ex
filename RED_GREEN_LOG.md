...
| 2.6 | `mix test test/calls_test.exs` failed with undefined `BaileysExo.Calls`; `test/notification_test.exs` failed with undefined notification decoder | Typed call/notification and internal-state regressions pass. |
